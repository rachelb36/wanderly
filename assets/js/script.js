  ...
  <html>
    ...
    <section class="section">
      <div class="container">
        ...
        <div class="box">
          <input type="text" id="city-search" placeholder="Enter your destination here." />
        </div>
        <div><button id="search-button">Search</button></div>
       <video src="./assets/185841-876533119_small.mp4" muted autoplay loop alt="a video of the sea"></video>
       <div class="cover"></div>
    </section>
